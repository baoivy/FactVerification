...
from prepare_data import UITClaimClassificationData
...
def get_parse():
    ...
    parser.add_argument("--encoder_name", type=str, default="joeddav/xlm-roberta-large-xnli")
    ...
    parser.add_argument("--relevant_classification", type=bool, default=False)
...
def main():
    ...
    all_data = UITClaimClassificationData(args)
